...
class Cduyetlopmon extends MY_Controller
{
    ...
    public function capnhat_lopmon(){
     ...
     public function xuatExcel(){
        ...
        $khoa = $this->Mduyetlopmon->layDonViCanBo($this->_session['ma_canbo']);
        ...
        $array_content['A' . $start++]      = 'KHOA ' . $khoa['ten_donvi_upper'];
        ...
        $objPHPExcel->getActiveSheet()->freezePane('A' . ($start + 1));
