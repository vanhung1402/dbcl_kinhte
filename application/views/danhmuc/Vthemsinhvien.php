         ...
         <form method="POST" action="" enctype="multipart/form-data" data-toggle="validator">
            <div class="col-sm-5">
               <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                  ...
                  <span class="fileinput-new">Chọn file</span> <span class="fileinput-exists">Sửa</span>
            ...
            <a class="btn btn-info waves-effect waves-light pull-right" href="uploads/Mau_import_sinh_vien.xlsx?ver=1.01" name="excel" title="File Excel mẫu">
